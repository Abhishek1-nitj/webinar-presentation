...
import llmWorkflowImage from '../assets/llm-workflow.png';
...
const Slide32sPromptingIntro = () => (
  <section className="slide-section min-h-screen w-full flex items-center justify-center px-6 md:px-10 lg:px-16 relative overflow-hidden">
    ...
    <div className="relative z-10 max-w-6xl w-full space-y-6 text-center">
      <motion.h2
      ...
      <motion.div
        className="rounded-[2rem] border border-white/10 bg-white/5 px-6 py-6 space-y-5"
        initial={{ opacity: 0, y: 30 }}
        whileInView={{ opacity: 1, y: 0 }}
